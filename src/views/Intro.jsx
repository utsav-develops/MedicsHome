...
const Intro = () => {
  ...
  const slides = [
    {
      key: 1,
      title: t('findNurseTitle'),
      text: t('findNurseText'),
      image: require('.././assets/json/slider_1.json'),
      bg: colors.theme_bg_three,
    },
    {
      key: 2,
      title: t('locateNurseTitle'),
      text: t('locateNurseText'),
      image: require('.././assets/json/slider_2.json'),
      bg: colors.theme_bg_three,
    },
    {
      key: 3,
      title: t('meetNurseTitle'),
      text: t('meetNurseText'),
      image: require('.././assets/json/mobile.json'),
      bg: colors.theme_bg_three,
    }
  ];
  ...
  <>
    ...
    <SafeAreaView style={styles.container}>
        ...
        <AppIntroSlider
          ...
          showSkipButton
          showPrevButton
          activeDotStyle={{ backgroundColor: colors.medics_blue }}
