...
const CreateName = (props) => {
    ...
    const navigate = async () => {
        ...
        navigation.navigate('CheckPerson');
    }
    ...
    <>
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>{t('enterYourName')}</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>{t('enterfirst_lastName')}</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
