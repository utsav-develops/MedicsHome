            ...
            <ScrollView>
                <View style={{ padding: 20 }}>
                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <View style={{ margin: 5 }} />
                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: normal, textAlign: 'center' }}>Join Today to our pro membership and get more benefits like free bookings, discounts, exclusive offers like that</Text>
                    </View>
                ...
                <View>
                    <View style={{ flexDirection: 'row', width: '100%', borderBottomWidth: 2, padding: 20, borderColor: colors.lite_bg }}>
                        ...
                        <View style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                            <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: normal }}>50% off bookings</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', width: '100%', borderBottomWidth: 2, padding: 20, borderColor: colors.lite_bg }}>
                        <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <View style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                            <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: normal }}>Free locum cancellations</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', width: '100%', borderBottomWidth: 2, padding: 20, borderColor: colors.lite_bg }}>
                        <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', borderBottomWidth: 2, padding: 20, borderColor: colors.lite_bg }}>
                        ...
                        <View style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                            <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: normal }}>Upto 100 free bookings a month</Text>
                        </View>
                    </View>
                </View>
