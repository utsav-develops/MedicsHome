        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{t('complaint')}</Text>
                </View>
            </View>
            <ScrollView>
                    ...
                    >
                        ...
                        <View style={{ width: '100%', backgroundColor: colors.theme_bg_three, borderRadius: 10, padding: 20, marginTop:5, marginBottom:5 }}>
                            <View style={{ width:'100%', alignItems:'flex-start', justifyContent:'center'}}>
                                ...
                                <View style={{ margin:3 }} />
                                <Text style={{ color: colors.theme_fg_two, fontSize: f_s, fontFamily: bold }}>{sub_category_data.short_description}</Text>
                            </View>
                        </View>
                        <View style={{ width: '100%', backgroundColor: colors.theme_bg_three, borderRadius: 10, padding: 20, marginTop:5, marginBottom:5 }}>
                            ...
                            <View style={{ width: '100%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg, borderRadius:10, borderWidth:1, borderStyle: 'dotted' }}>
                                <TextInput
                                    placeholder={t('enterDetailsAboutComplaint')}
                                    secureTextEntry={false}
                                    multiline={true}
                                    numberOfLines={10}
                                    placeholderTextColor={colors.grey}
