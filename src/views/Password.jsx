        ...
        if (status == 1) {
            try {
                ...
                if(data.patient_id !== null){
                    await AsyncStorage.setItem('patient_id', data?.patient_id.toString());
                ...
                global.patient_id = await data.patient_id;
    ...
    <>
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>{t('enterPassword')}</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>{t('needtoenterPassword')}</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
                    ...
                    <Text onPress={forgot_password.bind(this)} numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal, textAlign: 'right' }}>{t('forgotPassword')}?</Text>
