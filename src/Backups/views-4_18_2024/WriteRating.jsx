    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ position: 'absolute', bottom: 0, width: '100%', height: 100, alignItems: 'center', justifyContent: 'center' }}>
        <TouchableOpacity activeOpacity={1} style={{ width: '90%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
          <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontWeight: 'bold' }}>Submit</Text>
        </TouchableOpacity>
      </View>
      <ScrollView>
        <View style={{ padding: 20 }}>
          <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontWeight: 'bold' }}>Sarath Kannan</Text>
          </View>
        </View>
        <View style={{ margin: 10 }} />
        <View style={{ padding: 20 }}>
          <View style={{ alignItems: 'center', justifyContent: 'center', }}>
            <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_l, fontWeight: 'bold' }}>How was your work?</Text>
            <View style={{ margin: 5 }} />
            <Text style={{ color: colors.grey, lineHeight: 25, fontSize: f_s, fontWeight: 'normal', textAlign: 'center' }}>Your feedback will help improve driving experience</Text>
          </View>
