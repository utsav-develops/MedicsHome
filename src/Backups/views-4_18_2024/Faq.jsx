            ...
            <Animated.View style={[
                ...
                <TouchableOpacity activeOpacity={1} onPress={navigate_faq_details.bind(this, item)} style={{ flexDirection: 'row', padding: 20 }}>
                    ...
                    <View style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                        <Text style={{ color: colors.theme_fg_two, fontSize: f_s, fontWeight: 'normal' }}>{item.question}</Text>
                    </View>
                </TouchableOpacity>
            </Animated.View>
        );
        ...
        <View style={styles.container}>
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontWeight: 'bold' }}>{t('faqs')}</Text>
                </View>
            </View>
            <FlatList
            data={data}
