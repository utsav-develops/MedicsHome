               ...
               <ScrollView contentContainerStyle={{ paddingBottom: '100%' }}>
                    ...
                    <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_bg, padding: 20, flexDirection: 'row' }}>
                        ...
                        <View style={{ width: '90%', alignItems: 'center', justifyContent: 'center' }}>
                            <Text numberOfLines={1} style={{ color: colors.theme_fg_three, fontSize: f_25, fontweight: regular }}><Text style={{ fontWeight: 'bold' }}>{app_name}</Text> {t('receipt')}</Text>
                        </View>
                    </View>
                    <View style={{ padding: 20 }}>
                        <View style={{ width: '100%' }}>
                            <Text style={{ letterSpacing: 1.5, lineHeight: 40, color: colors.theme_fg_two, fontSize: f_25, fontweight: regular, textAlign: 'center' }}>{t('dear')} <Text style={{ fontWeight: 'bold' }}>{data.workplace.first_name}</Text>, {t('thank')} {app_name} {t('thank_nep')}</Text>
                            <View style={{ margin: 5 }} />
                            <Text style={{ color: colors.grey, fontSize: f_s, fontweight: regular, textAlign: 'center' }}>{t('enjoy')}</Text>
                        </View>
                        <View style={{ margin: 20 }} />
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <View style={{ flexDirection: 'row' }}>
                                    <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_25, fontWeight: 'bold' }}>{t('total')}</Text>
                                    <View style={{ margin: 5 }} />
                                    <Icon type={Icons.MaterialIcons} name="credit-card" color={colors.theme_fg_two} style={{ fontSize: 30 }} />
                                </View>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_25, fontWeight: 'bold' }}>{global.currency}{(data.total) - (data.tip)}</Text>
                            </View>
                        </View>
                        <View style={{ margin: 5 }} />
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontWeight: 'normal' }}>{t('handlingfee')}</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontWeight: 'normal' }}>{t('bookingPrice')}</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_s, fontWeight: 'normal' }}>{global.currency}{data.collection_amount}</Text>
                            </View>
                        </View>

                        <View style={{ flexDirection: 'row', borderTopWidth: 0.5, borderColor: colors.grey, marginTop: 10, paddingTop: 10 }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontWeight: 'normal' }}>{t('tip')}</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                    ...
                    <View style={{ padding: 20 }}>
                        <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontWeight: 'normal' }}>{t('bookingDetails')}</Text>
                        <View style={{ margin: 5 }} />
                    ...
                    {from != 'home' &&
                        <View>
                            ...
                            <View style={{ padding: 20 }}>
                                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontWeight: 'normal' }}>{t('needHelp')}?</Text>
                                <View style={{ margin: 5 }} />
                                <Text style={{ color: colors.grey, fontSize: f_xs, fontweight: regular }}>{t('registerComplaint')} </Text>
                                <View style={{ margin: 5 }} />
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <View style={{ margin:5 }}/>
                                            <Text style={{ color: colors.theme_fg_two, fontSize: f_s, color: colors.theme_fg_two, fontWeight: 'bold' }}>{t('support')}</Text>
                                        </TouchableOpacity>
                                    </View>
                            </View>
                        </View>
            ...
            {data.ratings == 0 && from == 'home' &&
                <View style={{ position: 'absolute', bottom: 0, width: '100%', height: 100, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                    <TouchableOpacity onPress={handle_back_button_click.bind(this)} activeOpacity={1} style={{ width: '45%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontWeight: 'bold' }}>{t('home')}</Text>
                    </TouchableOpacity>
                    <View style={{ width: '3%' }} />
                    <TouchableOpacity onPress={navigate_rating.bind(this, data)} activeOpacity={1} style={{ width: '45%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontWeight: 'bold' }}>{t('leaveReview')}</Text>
                    </TouchableOpacity>
                </View>
            }
