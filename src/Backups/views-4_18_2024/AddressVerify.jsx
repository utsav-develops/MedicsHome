    ...
    <ScrollView style={styles.container}>
      ...
      {upload_status == 0 ?
        <View style={{ padding: 10 }}>
          ...
          <View>
            ...
            <TouchableOpacity onPress={move_to_upload.bind(this, 'address_proof', address_proof.status_name, address_proof.path)} activeOpacity={1} style={{ borderWidth: 1, padding: 10, borderRadius: 5, borderStyle: 'dashed', flexDirection: 'row' }}>
              <View style={{ width: '70%' }}>
                <Text style={{ fontWeight: 'bold', color: address_proof.color, fontSize: f_s }}>{address_proof.status_name}</Text>
                <View style={{ margin: 5 }} />
                <Text style={{ fontWeight: 'normal', color: colors.grey, fontSize: f_xs }}>{t('addressProofImage')}</Text>
              </View>
        ...
        <View style={{ padding: 20, alignItems: 'center', justifyContent: 'center' }}>
          <Text style={{ fontWeight: 'bold', color: colors.theme_fg_two, fontSize: f_s }}>{t('waitAdmin')}</Text>
          ...
          <TouchableOpacity onPress={go_back.bind(this)} activeOpacity={1} style={{ width: '100%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
            <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontWeight: 'bold' }}>{t('goToHome')}</Text>
          </TouchableOpacity>
        </View>
      }
      {drop_down_alert()}
