        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontWeight: 'bold' }}>{t('compliance')}</Text>
                </View>
            </View>
            <ScrollView>
                {on_load == 1 &&
                    <View>
                        ...
                        <ScrollView>
                            <View style={{ alignItems: 'center' }}>
                                <Text style={{ color: colors.theme_fg_two, fontSize: f_xl, fontWeight: 'bold' }}>{t('regulatoryBodydetails')}</Text>
                                <View style={{ margin: 20 }} />
                                <View style={{ width: '90%' }}>
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontWeight: 'bold' }}>{t('registrationNumber')}</Text>
                                        <View style={{ margin: 5 }} />
                                    ...
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontWeight: 'bold' }}>{t('DBScertificate')}</Text>
                                        <View style={{ margin: 5 }} />
                                    ...
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontWeight: 'bold' }}>{t('indemnityInsurance')}</Text>
                                        <View style={{ margin: 5 }} />
                                    ...
                                    <View style={{ marginBottom: 20 }}>
                                        <Text style={{ color: colors.text_grey, fontSize: f_xs, fontWeight: 'bold' }}>{t('vaccineCertificate')}</Text>
                                        <View style={{ margin: 5 }} />
