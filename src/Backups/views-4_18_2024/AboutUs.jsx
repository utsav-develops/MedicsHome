...
import { screenHeight, screenWidth, bold, regular, api_url, get_about, logo, f_m, f_l, f_s, f_xl } from '../config/Constants';
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontWeight: 'bold' }}>{t('aboutUs')}</Text>
                </View>
            </View>
            <ScrollView>
                ...
                {on_load == 1 &&
                    <View>
                        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <View style={{ margin: 10 }} />
                            <Text style={{ color: colors.theme_fg_two, fontSize: f_m, fontweight: regular }}>
                        ...
                        <View style={{ backgroundColor: colors.theme_bg_three, padding: 10, margin: 10, borderRadius: 10 }}>
                            <View style={{ margin: 10 }}>
                                <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_l, fontWeight: 'bold' }}>Who we are?</Text>
                                <View style={{ margin: 5 }} />
