...
**Medics Home** is a mobile application designed for patients and family members to hire trained **caregivers and staff nurses** for home care.
The app also includes a built-in **electronic medicine system**, **health record management**, and real-time features to support daily patient care.
...
> Note: You must provide your own `.env`, Firebase configuration files, and API URLs.
> These are intentionally excluded from this repo for security.
